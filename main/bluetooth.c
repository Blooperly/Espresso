...
// GATTS Profile List
static struct gatts_profile_inst gl_profile_tab[GATTS_APP_LAST] = {
    [GATTS_APP] = {
        .gatts_cb = BLUETOOTH_profile_event,
...
// *J* In progress: example_write_event_env
...
// *J* In progress: example_exec_write_event_env
...
static void BLUETOOTH_profile_event(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    switch (event) {
        case ESP_GATTS_REG_EVT:
            ESP_LOGI(TAG, "BLUETOOTH_profile_event: REGISTER_APP_EVT, status %d, app_id %d\n", param->reg.status, param->reg.app_id);
            gl_profile_tab[GATTS_APP].service_id.is_primary = true;
            gl_profile_tab[GATTS_APP].service_id.id.inst_id = 0x00;
            gl_profile_tab[GATTS_APP].service_id.id.uuid.len = ESP_UUID_LEN_16;
            gl_profile_tab[GATTS_APP].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_TEST_A;
...
#endif
            esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[GATTS_APP].service_id, GATTS_NUM_HANDLE_TEST_A);
            break;
        ...
        case ESP_GATTS_WRITE_EVT:
            ...
            if (!param->write.is_prep){
                ...
                if (gl_profile_tab[GATTS_APP].descr_handle == param->write.handle && param->write.len == 2){
                    ...
                    if (descr_value == 0x0001){
                        if (a_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                            ...
                            esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[GATTS_APP].char_handle,
        ...
        case ESP_GATTS_CREATE_EVT:
            ...
            gl_profile_tab[GATTS_APP].service_handle = param->create.service_handle;
            gl_profile_tab[GATTS_APP].char_uuid.len = ESP_UUID_LEN_16;
            gl_profile_tab[GATTS_APP].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST_A;

            esp_ble_gatts_start_service(gl_profile_tab[GATTS_APP].service_handle);
            a_property = ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_NOTIFY;
            esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[GATTS_APP].service_handle, &gl_profile_tab[GATTS_APP].char_uuid,
        ...
        case ESP_GATTS_ADD_CHAR_EVT:
            ...
            esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab[GATTS_APP].service_handle, &gl_profile_tab[GATTS_APP].descr_uuid,
        ...
        case ESP_GATTS_ADD_CHAR_DESCR_EVT:
            gl_profile_tab[GATTS_APP].descr_handle = param->add_char_descr.attr_handle;
        ...
        case ESP_GATTS_CONNECT_EVT:
            ...
            gl_profile_tab[GATTS_APP].conn_id = param->connect.conn_id;
...
// *J* In progress: BLUETOOTH_gatts_event
